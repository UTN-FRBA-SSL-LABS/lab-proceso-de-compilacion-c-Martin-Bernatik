...
> **R:**porque lee las lineas de las directivas
...
> **R:**No encontro nada porque no existe el patron en el archivo
...
> **R:** comunican el nombre del archivo y su numero de linea. El archivo del cual proviene el bloque que contiene la declaracion de printf es "stdio.h"
---
...
> **R:**estas instrucciones preparan la pila para la funcion
...
> **R:**porque programa.o declara que necesita "area_circulo" mientras que matematicas.o la define
...
> **R:**porque son funciones de la biblioteca dinámica del sistema y las resuelve el cargador dinamico cuando el programa las resuelve
...
> **R:**la macro funcion es reemplazada por texto en el preprocesador(antes de compilar)mientras que las funciones reales se compilan en tiempo de ejecucion. la macro desaparece en el preprocesador y la funcion real en tiempo de ejecucion. la funcion real es la unica que tiene verificacion de tipos
...
> **R:**mientras que "T" representa simbolos definidos en la seccion de codigo .text y la "D" los representa en la seccion del codigo .data. Los simbolos de tipo T viven en funciones y los simbolos de tipo D viven en variable global.
...
> **R:** no tengo linux ni macOS

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:**al no poder hacer la primer parte no pude hacer la primera
